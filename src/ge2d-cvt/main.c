...
int main(void) {
        ...
        int dst_width = 1920;
        int dst_height = 1080;
        int dst_format = PIXEL_FORMAT_YCbCr_420_SP_NV12;
    ...
    /* Initialize GE2D */
        ...
        amlge2d.ge2dinfo.dst_info.plane_number = 2;

        amlge2d.ge2dinfo.offset = 0;
        amlge2d.ge2dinfo.ge2d_op = op;
        amlge2d.ge2dinfo.blend_mode = BLEND_MODE_NONE;
    ...
    /* Configure for the conversion operation */
        ...
        amlge2d.ge2dinfo.src_info[0].layer_mode = LAYER_MODE_NONE;
        ...
        nv12_write(amlge2d.ge2dinfo.dst_info.vaddr[0], "./output.nv12", 1920, 1080);
